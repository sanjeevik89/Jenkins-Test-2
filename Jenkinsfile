  ...
  stages {
    ...
    stage('Pull-Files') {
      ...
      steps {
        ...
        sh "ssh user@${params.Source_Server} 'dzdo /opt/envmgr/bin/pull_files_source -l ${params.Source_File_Location} -f ${params.Source_File_Name} -e ${params.Is_PGP_Encrypted_File}'"
